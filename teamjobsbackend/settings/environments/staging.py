...
ALLOWED_HOSTS = [
    ...
    config("DOMAIN_NAME", "staging-api.teamjobs.com.au"),
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DJANGO_POSTGRES_DB", default="teamjobs-staging"),
        "USER": config("DJANGO_POSTGRES_USER", default="teamjobs-staging"),
        "PASSWORD": config("DJANGO_POSTGRES_PASSWORD", default=""),
        "HOST": config("DJANGO_DATABASE_HOST", default="pgsql"),
